...
// copied from https://github.com/ZenSepiol/Dear-ImGui-App-Framework/blob/main/src/lib/thread_pool/thread_pool.hpp
// changed decltype to std::invoke_results to handle member variables in classes
